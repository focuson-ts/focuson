import { copyFile, copyFiles, DirectorySpec, templateFile, writeToFile } from "@focuson-nw/files";
...
import { detailsLog, GenerateLogLevel, NameAnd, safeArray, safeObject, safeString, sortedEntries, toArray, unique } from "@focuson-nw/utils";
...
// This isn't the correct aggregation... need to think about this. Multiple pages can ask for more. I think... we''ll have to refactor the structure
  ...
  templateFile ( `${javaUtilsRoot}/FocusonBadRequest400Exception.java`, 'templates/raw/java/utils/FocusonBadRequest400Exception.java', params, directorySpec, details )
  templateFile ( `${javaUtilsRoot}/FocusonBadRequest400ExceptionHandler.java`, 'templates/raw/java/utils/FocusonBadRequest400ExceptionHandler.java', params, directorySpec, details )
  ...
  templateFile ( `${javaUtilsRoot}/FocusonNotFound404ExceptionHandler.java`, 'templates/raw/java/utils/FocusonNotFound404ExceptionHandler.java', params, directorySpec, details )
