...
export const LabelAndCheckboxInputCD: DisplayCompD = { import: "./copied/LabelAndInput", name: "LabelAndCheckboxInput", params: { label: { paramType: 'string', needed: 'defaultToCamelCaseOfName' } } }
