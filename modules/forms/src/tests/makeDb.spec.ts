...
import { occupationAndIncomeFullDomainDD, oneOccupationIncomeDetailsDD } from "../example/occupationAndIncome/occupationAndIncome.dataD";
...
describe ( "makeDb", () => {
  it ( "should make the maps that will hold the pulled data", () => {
    expect ( makeMaps ( occupationAndIncomeFullDomainDD ) ).toEqual ( [
      "Map OccupationAndIncomeFullDomain = new HashMap<>();",
      "Map CustomerOccupationIncomeDetails = new HashMap<>();",
      "Map OneOccupationIncomeDetails = new HashMap<>();"
    ])
  } )
