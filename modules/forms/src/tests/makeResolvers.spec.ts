...
describe ( "makeResolvers", () => {
  it ( "should make resolvers", () => {
    expect ( makeResolvers ( paramsForTest, ChequeCreditbooksPD, 'chequeCreditBooks', chequeCreditBooksRestD,
      ...
      "        Tuple2<Integer,String> params0 =  getMeMyData1(connection,dbName);",
      "        Integer val1 = params0.t1;",
      "        String val2 = params0.t2;",
      "        //from ChequeCreditbooks.rest[chequeCreditBooks].resolvers[\"getChequeCreditbooks\"]",
      "        Tuple2<Integer,String> params1 =  getMeMyData2(connection,dbName);",
      ...
      "    }",
      "",
      "    public Tuple2<Integer,String> getMeMyData1(Connection connection, Object dbName) throws SQLException {",
      ...
      "  }}",
      "    public Tuple2<Integer,String> getMeMyData2(Connection connection, Object dbName) throws SQLException {",
  ...
  it ( `should make a resolver for a 'get' that is done manually`, () => {
    expect ( makeResolvers ( paramsForTest, EAccountsSummaryPD, 'eAccountsSummary', eAccountsSummaryRestD,
      ...
      "        Double totalMonthlyCost =  totalMonthlyCost(connection,dbName,accountId);",
      "        Map<String,Object> result=new HashMap<>();",
      ...
      "    public Double totalMonthlyCost(Connection connection, String dbName, int accountId) throws SQLException {",
  ...
  it ( "should make resolvers for non 'get' resolvers", () => {
    expect ( makeResolvers ( paramsForTest, EAccountsSummaryPD, 'eAccountsSummary', eAccountsSummaryRestD,
      ...
      "        Tuple3<Double,Double,Double> params0 =  getTotalMonthlyCostStoredProc(connection,dbName,accountId);",
      ...
      "    }",
      "",
      "    public Tuple3<Double,Double,Double> getTotalMonthlyCostStoredProc(Connection connection, String dbName, int accountId) throws SQLException {",
  ...
  it ( "should make resolvers for a sql list resolvers", () => {
    expect ( makeResolvers ( paramsForTest, PostCodeMainPage, 'postcode', postcodeWithResolversRestD,
      ...
      "        Integer someValue =  audit(connection,dbName);",
      "        //from PostCodeMainPage.rest[postcode].resolvers[\"getPostCodeDataLine\"]",
      "        List<Map<String,Object>> params1 = get(connection,dbName,someValue);",
      ...
      "",
      "//If you have a compiler error in the type here, did you match the types of the output params in your manual code with the declared types in the .restD?",
      "    public Integer audit(Connection connection, String dbName) throws SQLException {",
      "      Integer someValue= 123;",
      "      return someValue;",
      "  }",
      "    public List<Map<String,Object>> get(Connection connection, String dbName, Object someValue) throws SQLException {",
