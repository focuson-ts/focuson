...
describe ( "makeSpringEndpoint", () => {
  it ( "should makeParamsForJava", () => {
    expect ( makeParamsForJava ( 'error', createPlanRestD, 'get' ) ).toEqual ( '@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestParam int createPlanId' )
    // expect ( makeParamsForJava ( createPlanRestD, 'list' ) ).toEqual ( '@RequestParam String accountId, @RequestParam String customerId' )
    expect ( makeParamsForJava ( 'error', createPlanRestD, 'create' ) ).toEqual ( '@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestBody String body' )
    expect ( makeParamsForJava ( 'error', createPlanRestD, 'update' ) ).toEqual ( '@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestParam int createPlanId, @RequestBody String body' )
    expect ( makeParamsForJava ( 'error', createPlanRestD, 'delete' ) ).toEqual ( '@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestParam int createPlanId' )
    expect ( makeParamsForJava ( 'error', createPlanRestD, 'getOption' ) ).toEqual ( '@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestParam int createPlanId' )
  } )
  it ( "should make an endpoint for a rest", () => {
    expect ( makeSpringEndpointsFor ( paramsForTest, EAccountsSummaryPD, 'eAccountsSummary', eAccountsSummaryRestD ) ).toEqual ( [
      ...
      "    public ResponseEntity getEAccountsSummary(@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestParam int clientRef, @RequestParam String dbName, @RequestHeader String employeeType) throws Exception{",
      ...
      "    public ResponseEntity state_invalidateEAccountsSummary(@RequestParam int accountId, @RequestParam int clientRef, @RequestParam String dbName, @RequestHeader String employeeType) throws Exception{",
      "        try (Connection connection = dataSource.getConnection()) {",
      ...
      "    public String querygetEAccountsSummary(@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestParam int clientRef, @RequestParam String dbName, @RequestHeader String employeeType) throws Exception{",
      ...
      "    public String querystate_invalidateEAccountsSummary(@RequestParam int accountId, @RequestParam int clientRef, @RequestParam String dbName, @RequestHeader String employeeType) throws Exception{",
  ...
  it ( "should make a second endpoint for a res", () => {
    expect ( makeSpringEndpointsFor ( paramsForTest, EAccountsSummaryPD, 'createPlanRestD', createPlanRestD ).map ( s => s.replace ( /"/g, "'" ) ) ).toEqual ( [
      ...
      "    public ResponseEntity getCreatePlan(@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestParam int createPlanId) throws Exception{",
      "        try (Connection connection = dataSource.getConnection()) {",
      ...
      "    public ResponseEntity createCreatePlan(@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestBody String body) throws Exception{",
      "        try (Connection connection = dataSource.getConnection()) {",
      ...
      "    public ResponseEntity updateCreatePlan(@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestParam int createPlanId, @RequestBody String body) throws Exception{",
      "        try (Connection connection = dataSource.getConnection()) {",
      ...
      "    public ResponseEntity deleteCreatePlan(@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestParam int createPlanId) throws Exception{",
      "        try (Connection connection = dataSource.getConnection()) {",
      "          return  ResponseEntity.ok('{}');",
      "        }",
      "    }",
      ...
      "    public String querygetCreatePlan(@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestParam int createPlanId) throws Exception{",
      ...
      "    public String querycreateCreatePlan(@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestBody String body) throws Exception{",
      ...
      "    public String queryupdateCreatePlan(@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestParam int createPlanId, @RequestBody String body) throws Exception{",
      ...
      "    public String querydeleteCreatePlan(@RequestParam int accountId, @RequestParam int applRef, @RequestParam int brandRef, @RequestHeader int clientRef, @RequestParam int createPlanId) throws Exception{",
  ...
  it ( "should make an endpoint for a repeating", () => {
    expect ( makeSpringEndpointsFor ( paramsForTest, RepeatingPageD, 'repeating', repeatingRestRD ).map ( s => s.replace ( /"/g, "'" ) ) ).toEqual ( [
      ...
      "    public ResponseEntity createRepeatingWholeData(@RequestHeader int clientRef, @RequestBody String body) throws Exception{",
      "        try (Connection connection = dataSource.getConnection()) {",
      ...
      "    public ResponseEntity getRepeatingWholeData(@RequestHeader int clientRef) throws Exception{",
      "        try (Connection connection = dataSource.getConnection()) {",
      ...
      "    public String querycreateRepeatingLine(@RequestHeader int clientRef, @RequestBody String body) throws Exception{",
      ...
      "    public String querygetRepeatingLine(@RequestHeader int clientRef) throws Exception{",
