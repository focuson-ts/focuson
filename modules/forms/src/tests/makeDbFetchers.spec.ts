...
describe ( "makeDbFetchers", () => {
  it ( "should make the java code for the fetcher - single item", () => {
    expect ( makeDBFetchers ( paramsForTest, JointAccountPageD, 'jointAccount', JointAccountPageD.rest.jointAccount ) ).toEqual ( [
      ...
      "import  focuson.data.fetchers.JointAccount.pre_JointAccount_getJointAccount_FFetcher;",
      ...
      "",
      "  @Component",
      "public class pre_JointAccount_get_FFetcherDB implements pre_JointAccount_getJointAccount_FFetcher {",
      "",
      "  @Autowired",
