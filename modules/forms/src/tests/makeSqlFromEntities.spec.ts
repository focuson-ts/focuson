...
describe ( "EntityFolder", () => {
  it ( "should walk all the nodes", () => {
    ...
    expect ( foldEntitys ( testFolder, theRestD.tables, theRestD.tables.entity, undefined, [] ) ).toEqual ( [
      "single ACC_TBL path [mainCustomer -> CUST_TBL,mainAddress -> ADD_TBL] => POST_CODE_TBL -- fp main",
      "single ACC_TBL path [mainCustomer -> CUST_TBL,mainAddress -> ADD_TBL] => CITY_TBL -- fp main",
      ...
      "single ACC_TBL path [jointCustomer -> CUST_TBL,jointAddress -> ADD_TBL] => POST_CODE_TBL -- fp joint",
      "single ACC_TBL path [jointCustomer -> CUST_TBL,jointAddress -> ADD_TBL] => CITY_TBL -- fp joint",
...
describe ( "findAliasAndTablesLinksForLinkDataFolder", () => {
  it ( "should generate aliasAndTables", () => {
    expect ( walkSqlRoots ( findSqlRoot ( theRestD.tables ), ( parent, r ) => simplifyAliasAndTables ( findAliasAndTableLinksForLinkData ( r ) ) ) ).toEqual ( [
      ...
      "ACC_TBL->ACC_TBL,mainCustomer->CUST_TBL,mainPostCode->POST_CODE_TBL,mainCity->CITY_TBL,mainAddress->ADD_TBL",
      "ACC_TBL->ACC_TBL,jointCustomer->CUST_TBL,joinPostCode->POST_CODE_TBL,joinCity->CITY_TBL,jointAddress->ADD_TBL"
    ] )
  } )
} )
describe ( "findWhereLinkDataForLinkData", () => {
    it ( "should generate  findWhereLinkDataForLinkData", () => {
      expect ( walkSqlRoots ( findSqlRoot ( theRestD.tables ), ( parent, r ) => simplifyWhereLinks ( findWhereLinksForSqlRoot ( r ) ) ) ).toEqual ( [
        ...
        [
          "mainAddress:ADD_TBL.postCode == mainPostCode:POST_CODE_TBL.id",
          "mainAddress:ADD_TBL.city == mainCity:CITY_TBL.id",
          "param accountId == ACC_TBL:ACC_TBL.acc_id",
          "param brandId == ACC_TBL:ACC_TBL.brand_id",
        ...
        [
          "jointAddress:ADD_TBL.postCode == joinPostCode:POST_CODE_TBL.id",
          "jointAddress:ADD_TBL.city == joinCity:CITY_TBL.id",
          "param accountId == ACC_TBL:ACC_TBL.acc_id",
          "param brandId == ACC_TBL:ACC_TBL.brand_id",
...
describe ( "findFieldsFromWhere", () => {
  it ( "find the fields in the where clauses. ", () => {
    expect ( walkSqlRoots ( findSqlRoot ( theRestD.tables ), ( parent, r ) =>
      ...
      [
        "mainAddress:ADD_TBL.postCode/undefined[]",
        "mainPostCode:POST_CODE_TBL.id/undefined[]",
        "mainAddress:ADD_TBL.city/undefined[]",
        "mainCity:CITY_TBL.id/undefined[]",
        "ACC_TBL:ACC_TBL.acc_id/undefined[]",
        "ACC_TBL:ACC_TBL.brand_id/undefined[]",
        "mainCustomer:CUST_TBL.id/undefined[]",
      ...
      [
        "jointAddress:ADD_TBL.postCode/undefined[]",
        "joinPostCode:POST_CODE_TBL.id/undefined[]",
        "jointAddress:ADD_TBL.city/undefined[]",
        "joinCity:CITY_TBL.id/undefined[]",
        "ACC_TBL:ACC_TBL.acc_id/undefined[]",
        "ACC_TBL:ACC_TBL.brand_id/undefined[]",
        "jointCustomer:CUST_TBL.id/undefined[]",
...
describe ( "findTableAndFieldFromDataD", () => {
  ...
  it ( "find the tables and fields from a dataD. ", () => {
    expect ( findTableAndFieldFromDataD ( JointAccountDd ).map ( t => simplifyTableAndFieldData ( t, true ) ) ).toEqual ( [
      ...
      "POST_CODE_TBL.postCode/postCode/main,addresses,postCode[This is a one line string,another one line string]",
      "CITY_TBL.city/city/main,addresses,city[This is a one line string,another one line string]",
      ...
      "POST_CODE_TBL.postCode/postCode/joint,addresses,postCode[This is a one line string,another one line string]",
      "CITY_TBL.city/city/joint,addresses,city[This is a one line string,another one line string]"
    ] )
  } )
} )
...
describe ( "generateGetSql", () => {
  it ( "should generate the get sql", () => {
    expect ( walkSqlLinkData ( findSqlLinkDataFromRootAndDataD ( findSqlRoot ( theRestD.tables ), JointAccountDd ), ( parent, ld ) => generateGetSql ( ld ) ) ).toEqual ( [
      ...
      [
        "select",
        "  mainAddress.postCode as mainAddress_postCode,",
        "  mainPostCode.id as mainPostCode_id,",
        "  mainAddress.city as mainAddress_city,",
        "  mainCity.id as mainCity_id,",
        "  ACC_TBL.acc_id as ACC_TBL_acc_id,",
        "  ACC_TBL.brand_id as ACC_TBL_brand_id,",
        "  mainCustomer.id as mainCustomer_id,",
        "  mainAddress.customerId as mainAddress_customerId,",
        "  ACC_TBL.mainCustomerId as ACC_TBL_mainCustomerId,",
        "  mainPostCode.postCode as mainPostCode_postCode,",
        "  mainCity.city as mainCity_city,",
        "  mainAddress.zzline1 as mainAddress_zzline1,",
        "  mainAddress.zzline2 as mainAddress_zzline2",
        " from",
        "  ACC_TBL ACC_TBL,",
        "  CUST_TBL mainCustomer,",
        "  POST_CODE_TBL mainPostCode,",
        "  CITY_TBL mainCity,",
        "  ADD_TBL mainAddress",
        " where mainAddress.postCode = mainPostCode.id and mainAddress.city = mainCity.id and  ACC_TBL.acc_id = ? and  ACC_TBL.brand_id = ? and mainCustomer.id = mainAddress.customerId and ACC_TBL.mainCustomerId = mainCustomer.id"
      ],
      [
        "select",
        "  jointAddress.postCode as jointAddress_postCode,",
        "  joinPostCode.id as joinPostCode_id,",
        "  jointAddress.city as jointAddress_city,",
        "  joinCity.id as joinCity_id,",
        "  ACC_TBL.acc_id as ACC_TBL_acc_id,",
        "  ACC_TBL.brand_id as ACC_TBL_brand_id,",
        "  jointCustomer.id as jointCustomer_id,",
        "  jointAddress.customerId as jointAddress_customerId,",
        "  ACC_TBL.jointCustomerId as ACC_TBL_jointCustomerId,",
        "  joinPostCode.postCode as joinPostCode_postCode,",
        "  joinCity.city as joinCity_city,",
        "  jointAddress.zzline1 as jointAddress_zzline1,",
        "  jointAddress.zzline2 as jointAddress_zzline2",
        " from",
        "  ACC_TBL ACC_TBL,",
        "  CUST_TBL jointCustomer,",
        "  POST_CODE_TBL joinPostCode,",
        "  CITY_TBL joinCity,",
        "  ADD_TBL jointAddress",
        " where jointAddress.postCode = joinPostCode.id and jointAddress.city = joinCity.id and  ACC_TBL.acc_id = ? and  ACC_TBL.brand_id = ? and jointCustomer.id = jointAddress.customerId and ACC_TBL.jointCustomerId = jointCustomer.id"
      ]
    ] )
  } )
...
describe ( "findAllTableAndFieldsIn", () => {
  ...
  it ( "should find the table  a table from multiple link datas.. because the tables can be used in multiple dataDs", () => {
    ...
    expect ( simplifyTableAndFieldDataArray ( findAllTableAndFieldsIn ( rdps ) ) ).toEqual ( [
      ...
      "POST_CODE_TBL.id/undefined",
      "ADD_TBL.city/undefined",
      "CITY_TBL.id/undefined",
      "ADD_TBL.customerId/undefined",
      "POST_CODE_TBL.postCode/postCode",
      "CITY_TBL.city/city",
      "ADD_TBL.zzline1/line1",
      "ADD_TBL.zzline2/line2",
      "ADD_TBL.zzline3/line3",
...
describe ( "findAllTableAndFieldDatasIn", () => {
  it ( "should group the field data by table", () => {
    ...
    expect ( findAllTableAndFieldDatasIn ( rdps ).map ( t => simplifyTableAndFieldsData ( t, true ) ) ).toEqual ( [
      ...
      "ADD_TBL => postCode/undefined:number,city/undefined:number,customerId/undefined:number,zzline1/line1:string/main,addresses,line1,zzline2/line2:string/main,addresses,line2,zzline3/line3:string/line3,zzline4/line4:string/line4",
      "POST_CODE_TBL => id/undefined:number,postCode/postCode:string/main,addresses,postCode",
      "CITY_TBL => id/undefined:number,city/city:string/main,addresses,city"
  ...
  it ( "should make maps for each sql root, from the link data", () => {
    expect ( walkSqlLinkData ( findSqlLinkDataFromRootAndDataD ( findSqlRoot ( theRestD.tables ), JointAccountDd ), ( parent, ld, path ) => {
      ...
      [
        ...
        "  }",
        "  ",
        "  public final Object mainAddress__postCode__mainPostCode__id;",
        "  public final Object mainAddress__city__mainCity__id;",
        "  ",
        "  public final Map<String,Object> _root = new HashMap<>();",
        "  public final Map<String,Object> main = new HashMap<>();",
        "  public final Map<String,Object> main_addresses = new HashMap<>();",
        ...
        "    this.main_addresses.put('city', rs.getString('mainCity_city'));",
        "    this.main_addresses.put('postCode', rs.getString('mainPostCode_postCode'));",
        ...
        "    ",
        "    this.mainAddress__postCode__mainPostCode__id = rs.getInt('mainAddress_postCode');",
        "    this.mainAddress__city__mainCity__id = rs.getInt('mainAddress_city');",
        "    ",
        "    _root.put('main', main);",
        "    main.put('addresses', main_addresses);",
        "    ",
      ...
      [
        ...
        "  }",
        "  ",
        "  public final Object jointAddress__postCode__joinPostCode__id;",
        "  public final Object jointAddress__city__joinCity__id;",
        "  ",
        "  public final Map<String,Object> _root = new HashMap<>();",
        "  public final Map<String,Object> main = new HashMap<>();",
        "  public final Map<String,Object> main_addresses = new HashMap<>();",
        ...
        "    this.joint_addresses.put('city', rs.getString('joinCity_city'));",
        "    this.joint_addresses.put('postCode', rs.getString('joinPostCode_postCode'));",
        ...
        "    ",
        "    this.jointAddress__postCode__joinPostCode__id = rs.getInt('jointAddress_postCode');",
        "    this.jointAddress__city__joinCity__id = rs.getInt('jointAddress_city');",
        "    ",
        "    _root.put('joint', joint);",
        "    joint.put('addresses', joint_addresses);",
        "    ",
