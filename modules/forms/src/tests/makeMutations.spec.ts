...
describe ( "makeMutations", () => {
  it ( "should create an mutation class with a method for each mutation for that rest - simple", () => {
    expect ( makeMutations ( paramsForTest, EAccountsSummaryPD, 'theRestName', eAccountsSummaryRestD, safeArray ( eAccountsSummaryRestD.mutations )[ 0 ] ) ).toEqual ( [
      ...
      "",
      "    public void EAccountsSummary_state_invalidate_auditStuff0(Connection connection, String dbName, int accountId, int clientRef) throws SQLException {",
      "        if (dbName.equals(IFetcher.mock)) {",
      "           System.out.println(\"Mock audit: EAccountsSummary_state_invalidate_auditStuff0( {'type':'string','value':'someString'}, accountId, clientRef+ )\");",
      "           return;",
      "    }",
  ...
  it ( "should create an mutation class with a method for each mutation for that rest - complex", () => {
    expect ( makeMutations ( paramsForTest, ChequeCreditbooksPD, 'theRestName', chequeCreditBooksRestD, safeArray ( chequeCreditBooksRestD.mutations )[ 0 ] ) ).toEqual ( [
      ...
      "  }}",
      "    public void ChequeCreditbooks_create_auditCreateCheckBook1(Connection connection, Object dbName, int brandRef, int accountId, Object checkbookId, Object checkbookIdPart2) throws SQLException {",
      "        if (dbName.equals(IFetcher.mock)) {",
      "           System.out.println(\"Mock audit: ChequeCreditbooks_create_auditCreateCheckBook1( brandRef, accountId, checkbookId, checkbookIdPart2+ )\");",
      "           return;",
      "    }",
      ...
      "    public void ChequeCreditbooks_create_manualLog2(Connection connection, Object dbName, Object checkbookId, Object checkbookIdPart2) throws SQLException {",
      "        if (dbName.equals(IFetcher.mock)) {",
      "           System.out.println(\"Mock audit: ChequeCreditbooks_create_manualLog2( checkbookId, checkbookIdPart2+ )\");",
      "           return;",
      "    }",
  ...
  it ( "should make mutations for cases: i.e. where only one of several mutations will happen depending on the situation", () => {
    expect ( makeMutations ( paramsForTest, PaymentsPageD, 'newPayments', newPaymentsRD, safeArray ( newPaymentsRD.mutations )[ 0 ] ) ).toEqual ( [
      ...
      "import java.sql.SQLException;",
      "//added by param ognl",
      "import somepackage.somepostfix.another.utils.IOGNL;",
      "import focuson.data.mutator.utils.Tuple2;",
      "@Component",
      "public class oneLine_Payment_createMutation {",
      "",
      "    @Autowired",
      "    somepackage.somepostfix.another.utils.IOGNL ognl;",
      "",
      "    public void oneLine_Payment_create_insertIntoTheData1(Connection connection, Object dbName) throws SQLException {",
      "        if (dbName.equals(IFetcher.mock)) {",
      "           System.out.println(\"Mock audit: oneLine_Payment_create_insertIntoTheData1( {'type':'autowired','name':'ognl','import':true,'class':'somepackage.somepostfix.another.utils.IOGNL','method':'ognl'}+ )\");",
      "           return;",
      "    }",
      "    try (PreparedStatement s = connection.prepareStatement(\"insert into xxx (paymentType) values (?)\")) {",
      "      s.setObject(1, ognl.ognl);",
      "      s.execute();",
      "      return;",
      "  }}",
      "//If you have a compiler error in the type here, did you match the types of the output params in your manual code with the declared types in the .restD?",
      "    public Tuple2<String,Integer> oneLine_Payment_create_create2(Connection connection, Object dbName, int brandRef, int accountId) throws SQLException {",
      "        if (dbName.equals(IFetcher.mock)) {",
      "           System.out.println(\"Mock audit: oneLine_Payment_create_create2( brandRef, accountId, {'type':'output','name':'one','javaType':'String'}, {'type':'output','name':'two','javaType':'Integer'}+ )\");",
      "           return new Tuple2<>(\"0\",1);",
      "    }",
      "      if (true && brandRef==3) {",
      "        Tuple2<String,Integer> params0 = oneLine_Payment_create_one2_0(connection,dbName,accountId);",
      ...
      "      }",
      "      if (true) {",
      "        Tuple2<Integer,String> params1 = oneLine_Payment_create_two2_1(connection,dbName,accountId);",
      ...
      "  }",
      "    public Tuple2<String,Integer> oneLine_Payment_create_one2_0(Connection connection, Object dbName, int accountId) throws SQLException {",
      "        if (dbName.equals(IFetcher.mock)) {",
      "           System.out.println(\"Mock audit: oneLine_Payment_create_one2_0( {'type':'string','value':'first'}, accountId, {'type':'output','name':'one','javaType':'String','sqlType':'CHAR'}, {'type':'output','name':'two','javaType':'Integer','sqlType':'INTEGER'}+ )\");",
      "           return new Tuple2<>(\"0\",1);",
      "    }",
      ...
      "      return new Tuple2<String,Integer>(one,two);",
      "  }}",
      "    public Tuple2<Integer,String> oneLine_Payment_create_two2_1(Connection connection, Object dbName, int accountId) throws SQLException {",
      "        if (dbName.equals(IFetcher.mock)) {",
      "           System.out.println(\"Mock audit: oneLine_Payment_create_two2_1( {'type':'string','value':'second'}, {'type':'output','name':'two','javaType':'Integer','sqlType':'INTEGER'}, {'type':'output','name':'one','javaType':'String','sqlType':'CHAR'}, accountId+ )\");",
      "           return new Tuple2<>(0,\"1\");",
      "    }",
