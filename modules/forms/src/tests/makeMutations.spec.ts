...
describe ( "makeMutations", () => {
  ...
  it ( "should make mutations for cases: i.e. where only one of several mutations will happen depending on the situation", () => {
    expect ( makeMutations ( paramsForTest, PaymentsPageD, 'newPayments', newPaymentsRD, safeArray ( newPaymentsRD.mutations )[ 0 ] ).map ( s => s.replace ( /"/g, "'" ) ) ).toEqual ( [
      ...
      "    }",
      "      if (true && brandRef==3){",
      "        Tuple15<String,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,String> params0 = one0_0(connection,msgs,dbName,accountId);",
      ...
      "      s.setObject(17,null);s.registerOutParameter(17,java.sql.Types.VARCHAR);",
      "      long start = System.nanoTime();",
      "      s.execute();",
      ...
      "      String fiveteen = s.getString(17);",
      ...
      "      msgs.error(fiveteen);",
      "return new Tuple15<String,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer,String>(one,two,three,four,five,six,seven,eight,nine,ten,eleven,twelve,thirteen,fourteen,fiveteen);",
      "}",
      "  }",
