...
describe ( " listComponentsIn", () => {
  ...
  it ( "should createAllReactComponents ", () => {
    expect ( createAllReactComponents ( paramsForTest, AllGuardCreator, makeButtons (), EAccountsSummaryPD ).map ( s => s.replace ( /"/g, "'" ) ) ).toEqual ( [
      ...
      "import { LabelAndStringInput } from '../formComponents/abelAndInput';",
      "import { LabelAndNumberInput } from '../formComponents/labelAndInput';",
      "import { Table } from '../formComponents/table';",
      "import { LabelAndBooleanInput } from '../formComponents/labelAndInput';",
      "import { LabelAndRadio } from '../formComponents/Radio';",
  ...
  it ( "should createAllReactComponents for a modal page that define a display on the data", () => {
    expect ( createAllReactComponents ( paramsForTest, AllGuardCreator, makeButtons (), listOccupationsModalPD ).map ( s => s.replace ( /"/g, "'" ) ) ).toEqual ( [
      ...
      "import { SearchListItemsCD } from '../formComponents/searchListItems';",
      "import {ListNextButton} from '../formComponents/listNextPrevButtons';",
      "import {ListPrevButton} from '../formComponents/listNextPrevButtons';",
      "import {ModalButton} from '@focuson/pages';",
      "import {ModalCancelButton} from '@focuson/pages';",
