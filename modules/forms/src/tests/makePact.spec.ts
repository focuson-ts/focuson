...
describe ( "makePacts", () => {
  ...
  it ( "make a rest pact for get", () => {
    expect ( makeRestPact ( paramsForTest, EAccountsSummaryPD, 'someRestName', EAccountsSummaryPD.rest.createPlanRestD, 'get' ) ).toEqual ( [
      ...
      "       CommonIds: {\"accountId\":12342312,\"applRef\":888,\"brandRef\":10,\"clientRef\":666,\"createPlanId\":777},",
      ...
      "         method: 'GET',",
      "         path:   '/api/createPlan',",
      "         query:{\"accountId\":\"12342312\",\"applRef\":\"888\",\"brandRef\":\"10\",\"clientRef\":\"666\",\"createPlanId\":\"777\"},",
  ...
  it ( "make a rest pact for create", () => {
    expect ( makeRestPact ( paramsForTest, EAccountsSummaryPD, 'someRestName', EAccountsSummaryPD.rest.createPlanRestD, 'create' ) ).toEqual ( [
      ...
      "         method: 'POST',",
      "         path:   '/api/createPlan',",
      "         query:{\"accountId\":\"12342312\",\"applRef\":\"888\",\"brandRef\":\"10\",\"clientRef\":\"666\"},",
