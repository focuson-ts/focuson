...
generate ( logLevel, directorySpec, devAppConfig, { ...params, focusOnVersion, thePackage: 'focuson.data', maxTuples }, javaOutputRoot, tsRoot, AllGuardCreator, makeButtons () ) ( generatedPages )
