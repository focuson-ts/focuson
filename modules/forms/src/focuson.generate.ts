...
generate ( logLevel, directorySpec, devAppConfig, { ...params, focusOnVersion, thePackage: 'somepackage.somepostfix.another', theme: 'theme-dark' }, javaOutputRoot, tsRoot, AllGuardCreator, makeButtons () ) ( generatedPages )
