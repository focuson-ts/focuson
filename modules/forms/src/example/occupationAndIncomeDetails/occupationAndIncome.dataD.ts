...
import { DataD, DateDD, IntegerDD, OneLineStringDD, RepeatingDataD, StringDD, StringPrimitiveDD } from "../../common/dataD";
import { DisplayCompD, TableCD } from "../../common/componentsD";
...
export const occupationIncomeDetailsDD: DataD = {
    ...
    structure: {
        ...
        currentEmployment: {dataDD: yesNoDD},
        occupation: {dataDD: StringDD},
        customerDescription: {dataDD: StringDD},
        ownShareOfTheCompany: {dataDD: yesNoDD},
        owningSharesPct: {dataDD: yesNoDD},
        workFor: {dataDD: StringDD},
        employmentType: {dataDD: employmentTypeDD},
        annualSalaryBeforeDeduction: {dataDD: IntegerDD},
        annualIncomeExcludingRent: {dataDD: IntegerDD},
        regularCommissionBonus: {dataDD: IntegerDD},
        dateOfEmploymentStart: {dataDD: StringDD},
        ...
        establishedYear: {dataDD: StringDD},
