...
export const PostCodeModalPage: ExampleModalPage = {
  ...
  buttons: {
    ...
    commit: { control: 'ModalCommitButton', confirm: { type: 'window', confirmActions: {command: 'message', msg: 'canceling'}, cancelActions: {command: 'message', msg: 'not canceling'}  , showCancelButton: false } }
  },
