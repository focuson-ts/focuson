...
export function SelectMandatePage(){
  return focusedPage<FState, MandateSearchDomain, Context> ( s =>  'Select Mandate' ) (//If there is a compilation here have you added this to the 'domain' of the main page
     ( state, d, mode, index ) => {
          const id=`page${index}`;
