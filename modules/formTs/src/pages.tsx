...
export const pages: MultiPageDetails<FState, Context> = {
    ...
    PostCodeDemo: { config: simpleMessagesConfig, lens: identity.focusQuery ( 'PostCodeDemo' ), pageFunction: PostCodeDemoPage(), initialValue: {"main":{},"postcode":{"search":"","searchResults":[]}} },
