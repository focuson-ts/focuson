...
import { OccupationAndIncomeSummary_OccupationAndIncomeDetailsRestDetails } from './OccupationAndIncomeSummary/OccupationAndIncomeSummary.rests';
...
export const restDetails: RestDetails<FState, SimpleMessage> = {
   OccupationAndIncomeSummary_OccupationAndIncomeDetailsRestDetails: OccupationAndIncomeSummary_OccupationAndIncomeDetailsRestDetails(commonIds, defaultDateFn),
