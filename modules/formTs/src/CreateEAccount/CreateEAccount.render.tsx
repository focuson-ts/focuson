...
export function CreateEAccountDataDD({id,state,mode,buttons}: FocusedProps<FState, CreateEAccountDataDDDomain,Context>){
  return <>
    ...
    <LabelAndRadio id={`${id}.type`} state={state.focusOn('type')} mode={mode} label='type' buttons={buttons} enums={{"savings":"Savings","checking":"Checking"}} />
     {/*{"path":["savingsStyle"],"dataDD":"SavingsStyleDD","display":{"import":"../copied/Radio","name":"Radio","params":{"id":{"paramType":"object","needed":"id"},"state":{"paramType":"state","needed":"defaultToPath"},"mode":{"paramType":"object","needed":"no","default":"mode"},"ariaLabel":{"paramType":"string","needed":"no"},"enums":{"needed":"defaultToEnum","paramType":"object"}}}}*/}
