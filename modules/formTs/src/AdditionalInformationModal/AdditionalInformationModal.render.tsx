  ...
  return focusedPage<FState, AdditionalInformationDomain, Context> ( s => '' ) (//If there is a compilation here have you added this to the 'domain' of the main page
     ( state, d, mode ) => {
          ...
          return <div className='modalPage'>
           {/*{"dataDD":"AdditionalInformation","display":{"import":"","name":"AdditionalInformation","params":{"id":{"paramType":"object","needed":"id"},"state":{"paramType":"state","needed":"defaultToPath"},"mode":{"paramType":"object","needed":"no","default":"mode"},"ariaLabel":{"paramType":"string","needed":"no"}}},"path":[]}*/}
