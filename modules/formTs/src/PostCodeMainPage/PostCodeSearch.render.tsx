...
export function PostCodeSearchPage(){
  return focusedPage<FState, PostCodeSearchDomain, Context> ( s =>  'Post Code Search' ) (//If there is a compilation here have you added this to the 'domain' of the main page
     ( state, d, mode, index ) => {
          const id=`page${index}`;
