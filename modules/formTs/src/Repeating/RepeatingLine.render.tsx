...
export function RepeatingLinePage(){
  return focusedPage<FState, RepeatingLineDomain, Context> ( s =>  'Repeating Line' ) (//If there is a compilation here have you added this to the 'domain' of the main page
     ( state, d, mode, index ) => {
          const id=`page${index}`;
