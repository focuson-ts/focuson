...
export function ReasonPage(){
  return focusedPage<FState, AccountOverviewReasonDomain, Context> ( s =>  'Reason' ) (//If there is a compilation here have you added this to the 'domain' of the main page
     ( state, d, mode, index ) => {
          const id=`page${index}`;
