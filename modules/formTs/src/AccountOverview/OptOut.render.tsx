...
export function OptOutPage(){
  return focusedPage<FState, AccountOverviewOptOutDomain, Context> ( s =>  'Opt Out' ) (//If there is a compilation here have you added this to the 'domain' of the main page
     ( state, d, mode, index ) => {
          const id=`page${index}`;
