...
export function AccountOverview({id,state,mode,buttons}: FocusedProps<FState, AccountOverviewDomain,Context>){
  return <Layout details='[[3,3],[20]]'>
    ...
    <Table id={`${id}.criteria`} state={state.focusOn('criteria')} mode={mode} order={["criteria"]} />
     {/*{"displayParams":{"buttons":["reason"]},"path":["zFlagSet"],"dataDD":"YesNo","display":{"import":"../copied/Dropdown/LabelAndDropdown","name":"LabelAndDropdown","params":{"id":{"paramType":"object","needed":"id"},"state":{"paramType":"state","needed":"defaultToPath"},"mode":{"paramType":"object","needed":"no","default":"mode"},"ariaLabel":{"paramType":"string","needed":"no"},"label":{"paramType":"string","needed":"defaultToCamelCaseOfName"},"allButtons":{"paramType":"object","needed":"defaultToButtons"},"buttons":{"paramType":"string[]","needed":"no"},"enums":{"needed":"defaultToEnum","paramType":"object"}}}}*/}
    <LabelAndDropdown id={`${id}.zFlagSet`} state={state.focusOn('zFlagSet')} mode={mode} label='z flag set' allButtons={buttons} enums={{"X":"","N":"No","Y":"Yes"}} buttons={["reason"]} />
     {/*{"displayParams":{"buttons":["excessHistory"]},"path":["excessSixMonths"],"dataDD":"Integer","display":{"import":"../copied/LabelAndInput","name":"LabelAndNumberInput","params":{"id":{"paramType":"object","needed":"id"},"state":{"paramType":"state","needed":"defaultToPath"},"mode":{"paramType":"object","needed":"no","default":"mode"},"ariaLabel":{"paramType":"string","needed":"no"},"label":{"paramType":"string","needed":"defaultToCamelCaseOfName"},"allButtons":{"paramType":"object","needed":"defaultToButtons"},"buttons":{"paramType":"string[]","needed":"no"},"required":{"paramType":"boolean","needed":"no","default":true},"min":{"paramType":"object","needed":"no"},"max":{"paramType":"object","needed":"no"}}}}*/}
