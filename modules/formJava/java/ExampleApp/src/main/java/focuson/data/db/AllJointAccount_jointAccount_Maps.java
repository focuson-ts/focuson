...
public class AllJointAccount_jointAccount_Maps {
  Map account = new HashMap();
  Map main = new HashMap();
  Map mainName = new HashMap();
  Map joint = new HashMap();
  Map jointName = new HashMap();
  public AllJointAccount_jointAccount_Maps(ResultSet rs, List<AllJointAccount_jointAccount_0_Maps> aggMap0s, List<AllJointAccount_jointAccount_1_Maps> aggMap1s) throws SQLException {
