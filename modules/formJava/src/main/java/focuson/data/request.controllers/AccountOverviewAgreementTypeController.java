  ...
  public DataSource dataSource;
    ...
    public ResponseEntity getAccountOverviewAgreementType(@RequestParam String accountId, @RequestParam String applRef, @RequestParam String brandRef, @RequestParam String clientRef) throws Exception{
        try (Connection connection = dataSource.getConnection()) {
          return Transform.result(connection,graphQL.get(IFetcher.mock),AccountOverviewAgreementTypeQueries.getAccountOverviewAgreementType(accountId, applRef, brandRef, clientRef), "getAccountOverviewAgreementType");
        }
    }
