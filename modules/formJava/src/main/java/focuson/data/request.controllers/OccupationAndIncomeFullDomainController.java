...
import java.util.Arrays;
  ...
  OccupationAndIncomeFullDomainAudit __audit;
    ...
    public ResponseEntity getOccupationAndIncomeFullDomain(@RequestParam String accountId, @RequestParam String applRef, @RequestParam String brandRef, @RequestParam String clientRef) throws Exception{
        ...
        __audit.OccupationAndIncomeFullDomain_get_auditGetCustomerOccupation(IFetcher.mock,clientRef);
       return Transform.result(graphQL.get(IFetcher.mock),OccupationAndIncomeFullDomainQueries.getOccupationAndIncomeFullDomain(accountId, applRef, brandRef, clientRef), "getOccupationAndIncomeFullDomain");
    }
    ...
    public ResponseEntity updateOccupationAndIncomeFullDomain(@RequestParam String accountId, @RequestParam String applRef, @RequestParam String brandRef, @RequestParam String clientRef, @RequestBody String body) throws Exception{
        ...
        __audit.OccupationAndIncomeFullDomain_update_auditUpdateCustomerOccupation(IFetcher.mock,clientRef);
       return Transform.result(graphQL.get(IFetcher.mock),OccupationAndIncomeFullDomainQueries.updateOccupationAndIncomeFullDomain(accountId, applRef, brandRef, clientRef,   Transform.removeQuoteFromProperties(body, Map.class)), "updateOccupationAndIncomeFullDomain");
    }
