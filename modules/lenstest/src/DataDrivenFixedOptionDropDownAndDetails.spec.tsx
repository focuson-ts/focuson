...
describe ( 'DataDrivenFixedOptionDropDownAndDetails', () => {
  it ( 'should display main', () => {
    ...
    expect ( comp.html () ).toEqual (
      '<div style="display:flex"><div style="flex:50%"><div class="labelDropdown"><label>someLabel</label><select class="dropdown " disabled="" id="someId" required=""><option selected="" value="M">theJointData</option><option value="J">theJointData</option><option value="N">New Bank</option></select></div></div><div style="flex:50%"><p>Label: someLabel Id: someId Mode: view Data: theJointData</p></div></div>' )
  } )
  it ( 'should display joint', () => {
    ...
    expect ( comp.html () ).toEqual (
      '<div style="display:flex"><div style="flex:50%"><div class="labelDropdown"><label>someLabel</label><select class="dropdown " disabled="" id="someId" required=""><option value="M">theJointData</option><option selected="" value="J">theJointData</option><option value="N">New Bank</option></select></div></div><div style="flex:50%"><p>Label: someLabel Id: someId Mode: view Data: theJointData</p></div></div>' )
  } )
  it ( 'should display when no data path or display', () => {
    ...
    expect ( comp.html () ).toEqual (
      '<div style="display:flex"><div style="flex:50%"><div class="labelDropdown"><label>someLabel</label><select class="dropdown " disabled="" id="someId" required=""><option value="M">theJointData</option><option value="J">theJointData</option><option selected="" value="N">New Bank</option></select></div></div><div style="flex:50%"><div></div></div></div>' )
  } )
  ...
  it ( 'should display when there is nothing at the data path', () => {
    ...
    expect ( comp.html () ).toEqual (
      '<div style="display:flex"><div style="flex:50%"><div class="labelDropdown"><label>someLabel</label><select class="dropdown " disabled="" id="someId" required=""><option value="M"></option><option selected="" value="J"></option><option value="N">New Bank</option></select></div></div><div style="flex:50%"><p>Label: someLabel Id: someId Mode: view Data: </p></div></div>' )
  } )
} )