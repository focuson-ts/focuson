...
describe ( 'DataDrivenFixedOptionDropDownAndDetails', () => {
  it ( 'should display main', () => {
    ...
    expect ( comp.html () ).toEqual (
      '<div style="display:flex"><div style="flex:50%"><div class="dropdown-container "><label for="someId" class="input-label">someLabel</label><div class=""><select class="select " disabled="" id="someId" required=""><option selected="" value="M">theMainName</option><option value="J">theJointName</option><option value="N">New Bank</option></select></div></div></div><div style="flex:50%"><p>Label: someLabel Id: someId Mode: view Data: theMainData</p></div></div>' )
  } )
  it ( 'should display joint', () => {
    ...
    expect ( comp.html () ).toEqual (
      '<div style="display:flex"><div style="flex:50%"><div class="dropdown-container "><label for="someId" class="input-label">someLabel</label><div class=""><select class="select " disabled="" id="someId" required=""><option value="M">theMainName</option><option selected="" value="J">theJointName</option><option value="N">New Bank</option></select></div></div></div><div style="flex:50%"><p>Label: someLabel Id: someId Mode: view Data: theJointData</p></div></div>' )
  } )
  it ( 'should display when no data path or display', () => {
    ...
    expect ( comp.html () ).toEqual (
      '<div style="display:flex"><div style="flex:50%"><div class="dropdown-container "><label for="someId" class="input-label">someLabel</label><div class=""><select class="select " disabled="" id="someId" required=""><option value="M">theMainName</option><option value="J">theJointName</option><option selected="" value="N">New Bank</option></select></div></div></div><div style="flex:50%"><div></div></div></div>' )
  } )
  it ( 'should display when there is nothing at the value path', () => {
    ...
    expect ( comp.html () ).toEqual (
      '<div style="display:flex"><div style="flex:50%"><div class="dropdown-container "><label for="someId" class="input-label">someLabel</label><div class=""><select class="select " disabled="" id="someId" required=""><option value="M">theMainName</option><option selected="" value="J"></option><option value="N">New Bank</option></select></div></div></div><div style="flex:50%"><p>Label: someLabel Id: someId Mode: view Data: theJointData</p></div></div>' )
  } )
