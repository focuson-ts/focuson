 ...
 */
export const preMutateForPages = <S, PageDetails extends MultiPageDetails<S, MD>, MD extends ModalPagesDetails<S>> ( pageDetails: PageDetails, pageSelectionlens: Lens<S, PageSelection<PageDetails>> ) => ( state: S ): S => {
