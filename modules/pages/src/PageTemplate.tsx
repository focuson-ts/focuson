...
export function DefaultTemplate<S extends any, D extends any, Msgs, Context> ( { state, loading, focusedPage, pageMode, index }: PageTemplateProps<S, D, Context> ): JSX.Element {
  // @ts-ignore
