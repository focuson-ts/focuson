...
export function DefaultTemplate<S extends any, D extends any, Msgs, MD extends ModalPagesDetails<S>> ( { state, loading, focusedPage, pageMode }: PageTemplateProps<S, D> ): JSX.Element {
  // @ts-ignore
